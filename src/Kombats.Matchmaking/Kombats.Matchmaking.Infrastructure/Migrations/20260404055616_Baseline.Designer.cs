...
namespace Kombats.Matchmaking.Infrastructure.Migrations
{
    ...
    [Migration("20260404055616_Baseline")]
            ...
            modelBuilder.Entity("Kombats.Matchmaking.Infrastructure.Entities.MatchEntity", b =>
                {
                    ...
                    b.HasIndex("BattleId")
                        .IsUnique()
                        .HasDatabaseName("ix_matches_battle_id");

                    b.HasIndex("PlayerAId")
                        .HasDatabaseName("ix_matches_player_a_id");

                    b.HasIndex("PlayerBId")
                        .HasDatabaseName("ix_matches_player_b_id");

                    b.HasIndex("PlayerAId", "CreatedAtUtc")
                        .HasDatabaseName("ix_matches_player_a_id_created_at_utc");

                    b.HasIndex("PlayerBId", "CreatedAtUtc")
                        .HasDatabaseName("ix_matches_player_b_id_created_at_utc");
            ...
            modelBuilder.Entity("Kombats.Matchmaking.Infrastructure.Entities.OutboxMessageEntity", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("pk_matchmaking_outbox_messages");

                    b.HasIndex("Status", "OccurredAtUtc")
                        .HasDatabaseName("ix_matchmaking_outbox_messages_status_occurred_at_utc");
            ...
            modelBuilder.Entity("Kombats.Matchmaking.Infrastructure.Entities.PlayerCombatProfileEntity", b =>
                {
                    ...
                    b.HasKey("IdentityId")
                        .HasName("pk_player_combat_profiles");

                    b.HasIndex("CharacterId")
                        .HasDatabaseName("ix_player_combat_profiles_character_id");
            ...
            modelBuilder.Entity("MassTransit.EntityFrameworkCoreIntegration.InboxState", b =>
                {
                    ...
                    b.ToTable("inbox_state", "matchmaking");
                });
            ...
            modelBuilder.Entity("MassTransit.EntityFrameworkCoreIntegration.OutboxMessage", b =>
                {
                    ...
                    b.ToTable("outbox_message", "matchmaking");
                });
            ...
            modelBuilder.Entity("MassTransit.EntityFrameworkCoreIntegration.OutboxState", b =>
                {
                    ...
                    b.ToTable("outbox_state", "matchmaking");
                });
