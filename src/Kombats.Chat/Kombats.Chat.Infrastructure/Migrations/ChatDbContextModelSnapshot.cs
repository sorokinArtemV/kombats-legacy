...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Kombats.Chat.Domain.Conversations.Conversation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<Guid?>("ParticipantAIdentityId")
                        .HasColumnType("uuid")
                        .HasColumnName("participant_a_identity_id");

                    b.Property<Guid?>("ParticipantBIdentityId")
                        .HasColumnType("uuid")
                        .HasColumnName("participant_b_identity_id");
                    ...
                    b.HasIndex("ParticipantAIdentityId", "ParticipantBIdentityId")
                        .IsUnique()
                        .HasDatabaseName("ix_conversations_participant_a_identity_id_participant_b_ident")
                        .HasFilter("type = 1");
            ...
            modelBuilder.Entity("Kombats.Chat.Domain.Messages.Message", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<Guid>("SenderIdentityId")
                        .HasColumnType("uuid")
                        .HasColumnName("sender_identity_id");
            ...
            modelBuilder.Entity("Kombats.Chat.Domain.Messages.Message", b =>
                {
                    b.HasOne("Kombats.Chat.Domain.Conversations.Conversation", null)
                        .WithMany()
